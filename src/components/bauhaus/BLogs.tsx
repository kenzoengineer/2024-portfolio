...
const BLogs = () => {
    ...
    return (
        <div className="flex flex-col mr-10" ref={ref}>
            <div className="w-[50rem] h-36 overflow-x-hidden bg-b-black">
            ...
            <div className="relative w-[50rem] h-36 overflow-x-hidden bg-b-black">
                <div className="sl translate-x-full">
            ...
            <div className="relative w-[50rem] h-36 overflow-x-hidden bg-b-black">
                <div className="sr -translate-x-full">
                    <div className="absolute bg-b-blue h-36 w-[50rem]"></div>
